  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="min-h-screen bg-gray-100 dark:bg-gray-900 pt-20 transition-colors duration-200"
      >
        <div className="container mx-auto px-4 py-16">
          ...
          <motion.div
            className="font-mono text-justify text-blue-950 dark:text-gray-200 max-w-2xl mx-auto"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
