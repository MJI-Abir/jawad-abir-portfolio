...
const ProjectDetailsPage = ({ params }: { params: { id: string } }) => {
  ...
  if (!project) {
    return (
      <div className="flex justify-center items-center min-h-screen bg-gray-100">
        <h2 className="text-3xl text-blue-950">Project not found</h2>
      </div>
    );
  }
  ...
  return (
    <div className="bg-gray-100 text-blue-950 py-16">
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <Link
          href="/#work"
          className="inline-flex items-center text-blue-500 hover:text-blue-700 mb-8 transition-colors font-medium"
        >
        ...
        {/* Project Title */}
        <motion.h1
          className="text-4xl md:text-5xl font-bold mb-6 text-blue-950"
          initial="hidden"
          animate="visible"
          variants={fadeIn}
        >
        ...
        {/* Project Banner */}
        <motion.div
          className="w-full h-[40vh] sm:h-[50vh] md:h-[60vh] relative rounded-2xl overflow-hidden mb-16 shadow-lg"
          initial="hidden"
          animate="visible"
          variants={fadeIn}
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-20">
          ...
          >
            ...
            <div className="mb-5">
              ...
              <p className="text-gray-700">{project.buildDate}</p>
            </div>

            <div className="mb-8">
              <h4 className="text-blue-500 text-sm font-medium mb-3">
                Tech Stack
              </h4>
            ...
            <div className="flex flex-col gap-3">
              ...
              {project.githubUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white border border-gray-300 text-blue-950 py-3 px-4 rounded-lg text-center font-medium hover:border-blue-500 hover:shadow-md transition-all"
                >
                  View Source Code
                </a>
              )}
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {project.images.map((image, index) => (
              ...
              >
                <div
                  className={`relative h-64 rounded-2xl overflow-hidden shadow-md transition-all duration-300 group-hover:shadow-xl ${
        ...
        {/* Call to Action */}
        <motion.div
          className="bg-white rounded-2xl p-10 text-center shadow-md"
          initial="hidden"
          animate="visible"
          variants={slideUp}
        >
